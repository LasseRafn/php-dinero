...
class RequestBuilder
{
	...
	public function select( $fields ) {
		...
		$this->parameters['fields'] = is_array($this->parameters['fields'])
		    ? implode($this->parameters['fields']) : $this->parameters['fields'];

		$this->parameters['fields'] = empty($this->parameters['fields'])
		    ? $fields
